package NebulaGhostTextRPG.Data;

public class StoryRegistry {

    //ROOM DESC
    public static final String POD_STORAGE_DESC = "";
    public static final String CARGO_HOLD_DESC = "X";
    public static final String AIRLOCK_B_DESC = "";
    public static final String AIRLOCK_A_DESC = "";
    ...
    public static final String OBSERVATION_DECK_DESC = "";
    public static final String BRIDGE_DESC = "";
}
